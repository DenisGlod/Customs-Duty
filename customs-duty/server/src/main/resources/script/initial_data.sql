...
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (1, 1, 100, 2);
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (2, 1, 100, 2);
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (3, 1, 100, 2);
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (4, 1, 100, 2);
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (1, 2, 100, 2);
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (1, 3, 100, 2);
insert into productcargo(product_id, cargo_id, weight, customsDuty) values (1, 4, 100, 2);
